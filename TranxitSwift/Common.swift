...
class Common {
    ...
    class func storeUserData(from profile : Profile?){
        ...
        User.main.userType = profile?.user_type
        User.main.companyName = profile?.company_name
        User.main.wallet_limit = profile?.wallet_limit
        User.main.allow_negative = profile?.allow_negative
