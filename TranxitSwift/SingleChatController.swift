...
extension SingleChatController {
    ...
    private func initialLoads(){
        ...
        self.startObservers()
        textViewSingleChat.text = Constants.string.writeSomething.localize()
    }
...
extension SingleChatController : UITextViewDelegate {
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
        ...
        if textView.text == Constants.string.writeSomething.localize() {
            textView.text = .Empty
    ...
    func textViewDidEndEditing(_ textView: UITextView) {
        ...
        if textView.text == .Empty {
            textView.text = Constants.string.writeSomething.localize()
