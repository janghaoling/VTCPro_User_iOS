...
class ProfileViewController: UITableViewController {
    ...
    @IBOutlet private weak var textFieldCompany: HoshiTextField!
    @IBOutlet private weak var stackViewUserName: UIStackView!
...
extension ProfileViewController {
    ...
    private func setProfile(){
        ...
        let userType = User.main.userType
        if userType == Constants.string.usertype_company {
   
            self.stackViewUserName.isHidden = true
//            self.textFieldCompany.isHidden = false
            textFieldCompany.text = User.main.companyName
            textFieldCompany.borderActiveColor = nil
            textFieldCompany.borderInactiveColor = nil
        }
        else {
            self.stackViewUserName.isHidden = false
//            self.textFieldCompany.isHidden = true
    ...
    private func setDesign() {
        ...
        Common.setFont(to: textFieldCompany)
    ...
    @IBAction private func buttonSaveAction(){
        ...
        if User.main.userType == Constants.string.usertype_company {
            guard let companyName = self.textFieldCompany.text, companyName.count>0 else {
                UIScreen.main.focusedView?.make(toast: ErrorMessage.list.entercompanyName.localize())
                return
            }
        }
...
//        guard let profile = self.
        ...
        if User.main.userType == Constants.string.usertype_company {
            profile.company_name = self.textFieldCompany.text
        }
    ...
    private func localize() {
        ...
        self.textFieldCompany.placeholder = Constants.string.company.localize()
