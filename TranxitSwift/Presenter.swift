...
{
    func GetServiceType(api: Base, data: Data)
    {
        controller?.GetServiceType(api: api, data: PresenterProcessor.shared.GetServiceType(data: data))
    }
    
    func GetServicePOIDisatnceInfo(api: Base, data: Data)
    {
        controller?.GetServicePOIDisatnceInfo(api: api, data: PresenterProcessor.shared.GetServicePOIDisatnceInfo(data: data))
        
    }
    
    func CheckPoiPriceLogic(api: Base, data: Data)
    {
        controller?.CheckPoiPriceLogic(api: api, data: PresenterProcessor.shared.CheckPoiPriceLogic(data: data))
    }
    
    
    func CheckDrivingZone(api: Base, data: Data)
    {
        
        controller?.CheckDrivingZone(api: api, data: PresenterProcessor.shared.CheckDrivingZone(data: data))
    }
    ...
    func sendRequest2Array(api: Base, data: Data) {
        controller?.getRequest2Array(api: api, data: PresenterProcessor.shared.request2Array(data: data))
    }
