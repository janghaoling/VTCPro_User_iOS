...
enum Base : String{
    ...
    case servicesList = "/api/user/services" //old api call
    case estimateFare = "/api/user/estimated/fare"
    case getProviders = "/api/user/show/providers"
    
   // case sendRequest = "/api/user/send/request"  //old api call in start 2 location ride
    case sendRequest = "/api/user/send/requests"
    ...
    case updateRecurrent = "/api/user/request/recurrent/update"
    ...
    case getAds = "/api/user/get_advertisements"
    case terms_conditions = "/terms_conditions"

    case sendStopRequest = "/api/user/send/requests1"
    
    case checkdriverzone = "api/user/checkDrivingZone"
    
    case checkPoiPriceLogic = "api/user/checkPoiPriceLogic"
    
    case getServicePOIDisatnceInfo = "api/user/getServicePOIDisatnceInfo"
    
    case getServiceType = "api/user/getServiceType"
    
    case requestSMS = "/api/user/requestSMS"
    
    case verifySMS = "/api/user/verifySMS"
