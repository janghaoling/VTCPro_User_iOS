...
struct Constants {
    ...
    let theTermsConditions = "I have read and agreed the Terms and Conditions"
    ...
    let peak = "Peak Hours Charge"
    let tax = "Tax"
    let total = "Total"
    let submit = "Submit"
    let dismiss = "Dismiss"
    let addnoteforscheduleride = "Note"
    ...
    let luggage_capacity = "Luggage Capacity"
    ...
    let Never = "Never"
    let NoDriversFound = "No Drivers Found"
    let AlreadyRideCancelled = "Already Ride Cancelled"
    
    let writeanoteforthedriver = "Write a note for the driver"
    let no_thanks = "No thanks"
    let send = "Send_Note"
//    let SeverCouldnotbereached = "Sever Could not be reached."
//
//    let UpdatedSuccessfully = "Updated Successfully"
    let usertype_normal = "NORMAL"
    let usertype_company = "FLEET_COMPANY"
//    let usertype_fleet_normal = "FLEET_NORMAL"
//    let usertype_fleet_company = "FLEET_COMPANY"
//    let usertype_fleet_passenger = "FLEET_PASSENGER"
    
    //MARK: - SMS
    let Enter_your_mobile_number = "Enter your mobile number";
    let Phone_Number = "Phone Number";
    let Get_SMS = "Get SMS";
    let Verify_SMS = "Verify SMS";
    let Verify_Code = "Verify Code";
    let VERIFY = "VERIFY";
...
struct DateFormat {
    ...
    let MMM_dd_yyyy_hh_mm_ss_a = "dd MM, yyyy HH:mm:ss"
    let hhmmddMMMyyyy = "HH:mm:ss - dd:MM:yyyy"
    let ddMMyyyyhhmma = "dd-MM-yyyy HH:mm:ss"
    let ddMMMyyyy = "dd MM yyyy"
    let hh_mm_a = "HH:mm:ss"
...
enum Language : String, Codable, CaseIterable {
    ...
    var title : String {
        switch self {
        case .french:
            return Constants.string.french
        case .english:
