...
struct Storyboard {
    ...
    let AdsPageViewController = "AdsPageViewController"
    let AdsPageItemViewController = "AdsPageItemViewController"
    let GetSMSViewController = "GetSMSViewController"
    let VerifySMSViewController = "VerifySMSViewController"
    
    let VoiceChatViewController = "VoiceChatViewController"
...
struct XIB {
    ...
    let ScheduleRideNoteView = "ScheduleRideNoteView"
